...
const SERVICES = [
  {
    ...
    detail: "от 1 500 ₽/месяц",
  },
  {
    icon: "Package",
    title: "Сборка и упаковка",
    desc: "Комплектация заказов любой сложности, брендированная упаковка, вложения и промо-материалы.",
    detail: "от 15 ₽ за единицу",
  },
  {
    icon: "Truck",
    title: "Доставка по России",
    desc: "Доставляем собственным транспортом по всей России. Надёжно, быстро, без посредников.",
    detail: "Собственный транспорт",
  },
  {
    icon: "RotateCcw",
